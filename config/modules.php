...
return [
    ...
    */
    ...
    'stubs' => [
        ...
        'files' => [
            ...
            'webpack' => 'Resources/webpack.mix.js',
        ],
        'replacements' => [
            'routes/admin' => ['MODULE', 'LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE', 'PROVIDER_NAMESPACE', 'CONTROLLER_NAMESPACE'],
            'routes/web' => ['MODULE', 'LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE', 'PROVIDER_NAMESPACE', 'CONTROLLER_NAMESPACE'],
            ...
            'webpack' => ['MODULE', 'STUDLY_NAME', 'LOWER_NAME'],
        ],
        'gitkeep' => true,
    ],
    'paths' => [
    ...
    */
    ...
    'composer' => [
        ...
        'author' => [
            'name' => 'Thahaneen Ipix',
            'email' => 'thahaneen@ipixsolutions.com',
        ],
