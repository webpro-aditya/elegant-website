...
@push('script')
    <script src="{{ mix('js/admin/viewAuthor.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/viewAuthor.css') }}">
@endpush
        ...
        <div class="card-body pt-9 pb-0">
            <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
                <div
                    ...
                    @if ($author->thumbnail)
                        <img class="mw-50px mw-lg-75px" src="{{ Storage::disk('elegant')->url($author->thumbnail) }}"
                            alt="image" />
                    @else
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-1">
                                ...
                                <span class="badge badge-light-success me-auto">{{ $author->status }}</span>
                            </div>
                        </div>
            ...
            <div class="card-body pt-4">
                @include('author::admin.tabs.tabView.authorInfo')
            </div>
