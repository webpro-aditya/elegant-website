...
@push('script')
    <script src="{{ mix('js/admin/listSubscriber.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/listSubscriber.css') }}">
@endpush
...
<x-layout>
    ...
    <div class="card">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px kt-toolbar-filter" data-kt-menu="true"
                    ...
                    <div class="px-5 py-3">
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select form-control-solid mb-2" name="email"
                                data-kt-select2="true" id="email" data-server="true"
                                data-placeholder="Select Email"
                                data-option-url="{{ route('subscriber_options_email') }}"
                                value="{{ old('email') }}">
                            </select>
                        </div>
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listSubscriber"
                data-url="{{ route('subscriber_table') }}">
                <thead>
