...
<x-layout>
    @section('toolbar')
        <x-toolbar :breadcrumbs="$breadcrumbs">
            @can('course_create')
                <a href="{{ route('course_add') }}" class="btn btn-primary">Add Course</a>
            @endcan
        </x-toolbar>
    @endsection
    ...
    <div class="card">
                    ...
                    <div class="px-5 py-3">
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select form-control-solid mb-2" name="category_id" data-kt-select2="true"
                                id="category_id" data-server="true" data-placeholder="Select Category" data-dropdown-parent="#kt-toolbar-filter"
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listCourse" data-url="{{ route('course_table') }}">
                <thead>
