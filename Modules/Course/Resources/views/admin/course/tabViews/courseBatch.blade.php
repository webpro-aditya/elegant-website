...
<x-layout>
    ...
    @include('course::admin.course.courseInfo', ['activeMenu' => 'batch', 'course' => $course])
    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listBatch"
                data-url="{{ route('course_batch_table') }}">
                <thead>
                ...
                <form novalidate="novalidate" id="addBatchForm" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    ...
                    <div class="mb-10 fv-row fv-plugins-icon-container">
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <input type="text" name="name" class="form-control mb-2" placeholder="Days"
                                value="">
                            @error('name')
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <div class="d-flex">
                                ...
                                <select name="end_period" class="form-select form-control-solid mb-2"
                                    data-kt-select2="true" data-server="false">
                                    <option value="AM">AM</option>
                                    <option value="PM">PM</option>
                                </select>
                    ...
                    <div class="mb-5 fv-row fv-plugins-icon-container">
                        <button type="submit" id="btnSubmit"
                            class="batch-submit-btn btn btn-primary fv-button-submit w-100">
