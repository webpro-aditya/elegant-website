...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/discount/addDiscount.css') }}">
@endpush

@push('script')
    <script src="{{ mix('js/admin/discount/addDiscount.js') }}"></script>
@endpush

<x-layout>
    <form novalidate="novalidate" id="discountForm"
        class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework"
        action="{{ route('discount_create') }}"
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row fv-plugins-icon-container">
                        ...
                        <input type="number" name="attempt_per_user" class="form-control mb-2" id="attempt_per_user"
                            placeholder="Attempt Per User" value="">
