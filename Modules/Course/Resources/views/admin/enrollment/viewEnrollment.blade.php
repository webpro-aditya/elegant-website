...
@push('script')
<script src="{{ mix('js/admin/enrollment/listEnrollment.js') }}"></script>
@endpush

@push('style')
<link rel="stylesheet" type="text/css" href="{{ mix('css/admin/enrollment/listEnrollment.css') }}">
@endpush
    ...
    <div class="card mb-5 mb-xxl-8">
        <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $enrollment->user->name }}</a>
                                <a href="#">
                        ...
                        <div class="d-flex flex-column flex-grow-1 pe-8">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    ...
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-semibold fs-6 text-gray-500">Course</div>
                                    <!--end::Label-->
                                </div>
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <!--begin::Number-->
                                    ...
                                    <!--end::Number-->
                                    <!--begin::Label-->
                                    <div class="fw-semibold fs-6 text-gray-500">User</div>
                                    <!--end::Label-->
                                </div>
                                <!--end::Stat-->
                            </div>
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="pages/user-profile/projects.html">User</a>
                </li>
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="pages/user-profile/projects.html">Course</a>
                </li>
            </ul>
            <!--begin::Navs-->
        </div>
