@section('title', 'View Course Batch')

@push('script')
<script src="{{ mix('js/admin/batch/viewBatch.js') }}"></script>
@endpush

@push('style')
<link rel="stylesheet" type="text/css" href="{{ mix('css/admin/batch/viewBatch.css') }}">
@endpush

<x-layout>
    @section('toolbar')
        <x-toolbar :breadcrumbs="$breadcrumbs">
            <a href="{{ route('batch_edit', ['id' => $batch->id]) }}" class="btn btn-primary">Edit Batch</a>
        </x-toolbar>
    @endsection
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap">
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        <h1 class="symbol-label bg-warning text-inverse-warning fw-bold text-uppercase  display-1">{{ substr($batch->name, 0, 1) }}</h1>
                    </div>
                </div>
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $batch->name }}</a>
                                <a href="#">
                    ...
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="my-0">
                            <button type="button" class="btn btn-sm btn-icon btn-color-primary btn-active-light-primary" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">
                                <i class="ki-outline ki-batch fs-6"></i>
                            </button>
                            <!--begin::Menu 2-->
