...
<x-layout>
    {{-- @section('toolbar') --}}
        <x-toolbar :breadcrumbs="$breadcrumbs">
            {{-- @can('topic_create') --}}
            <a href="{{ route('topic_edit', ['id' => $topic->id]) }}" class="btn btn-primary">Edit Topic</a>
            {{-- @endcan --}}
        </x-toolbar>
    {{-- @endsection --}}
    ...
    <div class="card mb-5 mb-xxl-8">
        <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{ $topic->title }}</a>
                                <a href="#">
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <!--begin::Nav item-->
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="pages/user-profile/projects.html">Topics</a>
                </li>
            </ul>
            <!--begin::Navs-->
        </div>
