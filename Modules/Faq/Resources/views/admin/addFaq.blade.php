...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/addFaq.css') }}">
@endpush

@push('script')
    <script src="{{ mix('js/admin/addFaq.js') }}"></script>
@endpush

<x-layout>
    <form novalidate="novalidate" id="faqForm" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data"
    action="{{ route('faq_save') }}" method="POST">
    @csrf
    ...
    @include('faq::admin.addTab.addFaqTab')
