...
var IpixGalleryEdit = function() {
    var validateForm = function(e) {
        $('#editGalleryForm').submit(function (event) {
            var isValid = true;
    ...
    var statusEvent = function(e) {
        const target = document.getElementById('gallery_status');
        $("#gallery_status_select").change(function(e) {
