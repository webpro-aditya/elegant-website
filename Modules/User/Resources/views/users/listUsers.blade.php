...
@push('script')
    <script src="{{ mix('js/users/listUser.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/users/listUser.css') }}">
@endpush
...
@endsection
    <div class="card">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px kt-toolbar-filter" data-kt-menu="true" id="kt-toolbar-filter">
                    ...
                    <div class="px-5 py-3">
                        <div class="mb-5">
                            ...
                            <select id="roleId" class="form-select" data-kt-select2="true" data-server="true" data-placeholder="Select role" data-allow-clear="true" data-option-url="{{ route('options_roles') }}" data-dropdown-parent="#kt-toolbar-filter">
                            </select>
                        </div>
                        <div class="mb-5">
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listUsers" data-url="{{ route('user_table') }}">
                <thead>
