@section('title', 'List Free Resource')

@push('script')
<script src="{{ mix('js/admin/freeResource/listFreeResource.js') }}"></script>
@endpush

@push('style')
<link rel="stylesheet" type="text/css" href="{{ mix('css/admin/freeResource/listFreeResource.css') }}">
@endpush

<x-layout>
    @section('toolbar')
    <x-toolbar :breadcrumbs="$breadcrumbs">
        <a href="{{ route('free_resource_add') }}" class="btn btn-primary">Add Free Resource</a>
    ...
    <div class="card">
                ...
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px kt-toolbar-filter" data-kt-menu="true" id="kt-toolbar-filter">
                    ...
                    <div class="px-5 py-3">
                        ...
                        <div class="mb-5">
                            ...
                            <select id="type" class="form-select" data-kt-select2="true" data-placeholder="Select status" data-allow-clear="true" data-dropdown-parent="#kt-toolbar-filter">
                                <option value="">All</option>
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listFreeResource" data-url="{{ route('free_resource_table') }}">
                <thead>
