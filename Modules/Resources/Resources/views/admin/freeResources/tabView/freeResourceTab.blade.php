@push('script')
    <script src="{{ mix('js/admin/resourceContent/listResourceContent.js') }}"></script>
@endpush
...
<div class="card-header border-0 pt-6">
    <x-dt-toolbar>
        <a class="btn btn-primary" type="button" data-kt-load-drawer="true" data-url="{{ route('free_resource_contents_add', ['resource_id' => $resource->id]) }}" data-drawer-id="add_resource_content">
            Add Resource Content <i class="ki-outline ki-plus fs-3 text-inverse-dark"></i>
        </a>
...
<div class="card-body pt-0">
    <table class="table align-middle table-row-dashed fs-6 gy-5" id="listResourceContents"
        data-url="{{ route('free_resource_contents_table', ['resource_id' => $resource->id]) }}">
        <thead>
