...
@push('script')
    <script src="{{ mix('js/admin/contents/viewContent.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/contents/viewContent.css') }}">
@endpush
...
<x-layout>
    ...
    <div class="card mb-9">
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-6">
                <div
                    ...
                    @if ($contents->thumbnail)
                        <img class="mw-50px mw-lg-75px" src="{{ Storage::disk('elegant')->url($contents->thumbnail) }}"
                            alt="image" />
                    @else
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-1">
                                ...
                                <span class="badge badge-light-success me-auto">{{ $contents->status }}</span>
                            </div>
                            {{-- <div class="d-flex flex-wrap fw-semibold mb-4 fs-5 text-gray-500">{{ $contents->code }}</div> --}}
                        </div>
        ...
        <div class="card-body pt-4">
            @include('cms::admin.contents.tabView.contentInfo')
        </div>
