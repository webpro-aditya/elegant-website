...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        $content = Content::create([
            'slug' => Str::slug('elegant training section', '-'),
            'page_slug' => 'home',
            'is_deletable' => 1,
            'section' => 'web',
        ]);
        ...
        $translations = [
            [
                ...
                'title' => 'elegant training section',
            ...
            [
                ...
                'title' => 'section de formation élégante',
            ...
            [
                ...
                'title' => 'sección de entrenamiento elegante', 
    ...
    {
        // Find the content record by slug
        $content = Content::where('slug', Str::slug('elegant training section', '-'))->first();
