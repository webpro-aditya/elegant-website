...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/careerCategory/addCareerCategory.css') }}">
@endpush

@push('script')
    <script src="{{ mix('js/admin/careerCategory/addCareerCategory.js') }}"></script>
@endpush

<x-layout>
    <form novalidate="novalidate" id="categoryForm"
        class="form d-flex flex-column flex-lg-row "
        action="{{ route('career_category_save') }}" enctype="multipart/form-data" method="POST">
        @csrf
            ...
            <div class="card card-flush py-4">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <div class="rounded-circle bg-success w-15px h-15px" id="career_category_status"></div>
                    </div>
                </div>
                <div class="card-body pt-0">
                    <select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true"
                        data-placeholder="Select an option" id="career_category_status_select">
