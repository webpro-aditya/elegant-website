...
var IpixUsersAddBlogCategory = function () {
    ...
    var statusEvent = function (e) {
        const target = document.getElementById('blog_category_status');
        $("#blog_category_status_select").change(function (e) {
