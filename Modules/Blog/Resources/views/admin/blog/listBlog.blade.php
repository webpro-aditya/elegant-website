...
@push('script')
<script src="{{ mix('js/admin/blog/listBlog.js') }}"></script>
@endpush

@push('style')
<link rel="stylesheet" type="text/css" href="{{ mix('css/admin/blog/listBlog.css') }}">
@endpush
...
<x-layout>
    ...
    <div class="card">
            ...
            <x-dt-toolbar>
                <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px kt-toolbar-filter" data-kt-menu="true" id="kt-toolbar-filter">
                    ...
                    <div class="px-5 py-3">
                        ...
                        <div class="mb-5">
                            <label class="form-label fs-5 fw-semibold mb-3">Author:</label>
                        ...
                        <div class="mb-5">
                            ...
                            <select class="form-select form-control-solid mb-2" name="category_id" data-kt-select2="true"
                                id="category_id" data-server="true" data-placeholder="Select Category"
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listBlog" data-url="{{ route('blog_table') }}">
                <thead>
