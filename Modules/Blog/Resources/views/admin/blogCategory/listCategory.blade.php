@section('title', 'List Blog Categories')

@push('script')
    <script src="{{ mix('js/admin/blogcategory/listBlogCategory.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/blogcategory/listBlogCategory.css') }}">
@endpush
...
<x-layout>
    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listBlogCategory"
                data-url="{{ route('blog_category_table') }}">
                <thead>
