...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/blogcategory/editBlogCategory.css') }}">
@endpush

@push('script')
    <script src="{{ mix('js/admin/blogcategory/editBlogCategory.js') }}"></script>
@endpush
...
<x-layout>
    ...
    <form novalidate="novalidate" id="categoryForm"
        ...
        action="{{ route('blog_category_update') }}" enctype="multipart/form-data" method="POST">
        @csrf
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="text-muted fs-7">Set the blog category status.</div>
                </div>
            </div>
            <div class="card card-flush py-4">
                <div class="card-header">
                ...
                <div class="card-body pt-0">
                    <select class="form-select mb-2" name="is_featured" data-control="select2" data-hide-search="true"
                        ...
                        <option value="no" @if ($category->is_featured == 'no') selected @endif>No</option>
                        <option value="yes" @if ($category->is_featured == 'yes') selected @endif>Yes</option>
                    </select>
                    <div class="text-muted fs-7">Select an Option.</div>
                </div>
            </div>
        </div>
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            <div class="card card-flush mb-6 mb-xl-9">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('blog_category_list') }}" class="btn btn-light me-5">Cancel</a>
