...
// Class definition
var IpixAppLayoutBuilder = function() {
    var form;
    var actionInput;
    var url;
    var previewButton;
    ...
    var handleEngagePrebuilts = function() {
        ...
        if (IpixCookie.get("app_engage_prebuilts_modal_displayed") !== "1") {
            setTimeout(function() {
                const modal = new bootstrap.Modal(engagePrebuiltsModal);
                modal.show();

                const date = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000); // 30 days from now
                IpixCookie.set("app_engage_prebuilts_modal_displayed", "1", { expires: date });
            }, 3000);
        }
    }
    ...
    var handleEngagePrebuiltsViewMenu = function() {
        ...
        // Toggle Handler
        IpixUtil.on(engagePrebuiltsModal, '[data-kt-mode]', 'click', function(e) {
    ...
    var handleEngageToggle = function() {
        engageToggleOff.addEventListener("click", function(e) {
            ...
            IpixCookie.set("app_engage_hide", "1", { expires: date });
        ...
        engageToggleOn.addEventListener("click", function(e) {
            ...
            IpixCookie.remove("app_engage_hide");
    ...
    var handleThemeMode = function() {
        ...
        var check = document.querySelector('#kt_layout_builder_theme_mode_' + IpixThemeMode.getMode());
