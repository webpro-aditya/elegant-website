...
// Class definition
var IpixTablesWidget16 = function() {
    var chart1 = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function(chart, toggle, selector, data, initByDefault) {
        ...
        var strokeColor = IpixUtil.getCssVariableValue('--bs-gray-300');
        var baseColor = IpixUtil.getCssVariableValue('--bs-' + color);
        var lightColor = IpixUtil.getCssVariableValue('--bs-body-bg');
...
if (typeof module !== 'undefined') {
    module.exports = IpixTablesWidget16;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixTablesWidget16.init();
});