...
// Class definition
var IpixTimelineWidget4 = function() {
    // Private methods
    // Day timeline
    const initTimelineDay = () => {
        ...
        var options = {
            ...
            onInitialDrawComplete: function() {
                ...
                const blockUI = IpixBlockUI.getInstance(target);
    ...
    const handleBlockUI = () => {
        ...
        elements.forEach(element => {
            const blockUI = new IpixBlockUI(element, {
...
if (typeof module !== 'undefined') {
    module.exports = IpixTimelineWidget4;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixTimelineWidget4.init();
});