...
// Class definition
var IpixChartsWidget46 = function() {
    var chart = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function() {
        ...
        var negativeColor = element.hasAttribute('data-kt-negative-color') ? element.getAttribute('data-kt-negative-color') : IpixUtil.getCssVariableValue('--bs-gary-500');
        ...
        var baseColor = IpixUtil.getCssVariableValue('--bs-gray-800');
...
if (typeof module !== 'undefined') {
    module.exports = IpixChartsWidget46;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixChartsWidget46.init();
});