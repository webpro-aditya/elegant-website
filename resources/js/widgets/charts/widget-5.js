...
// Class definition
var IpixChartsWidget5 = function() {
    var chart = {
        self: null,
        rendered: false
    };
        ...
        var options = {
            ...
            xaxis: {
                ...
                labels: {
                    ...
                    style: {
                        colors: IpixUtil.getCssVariableValue('--bs-gray-400'),
                        fontSize: '14px',
                        fontWeight: '600',
                        align: 'left'
                    }
            ...
            yaxis: {
                labels: {
                    style: {
                        colors: IpixUtil.getCssVariableValue('--bs-gray-800'),
                        fontSize: '14px',
                        fontWeight: '600'
                    },
                    offsetY: 2,
...
if (typeof module !== 'undefined') {
    module.exports = IpixChartsWidget5;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixChartsWidget5.init();
});