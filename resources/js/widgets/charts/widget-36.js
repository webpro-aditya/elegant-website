...
// Class definition
var IpixChartsWidget36 = function() {
    var chart = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function(chart) {
        ...
        var baseprimaryColor = IpixUtil.getCssVariableValue('--bs-primary');
        var lightprimaryColor = IpixUtil.getCssVariableValue('--bs-primary');
        var basesuccessColor = IpixUtil.getCssVariableValue('--bs-success');
        var lightsuccessColor = IpixUtil.getCssVariableValue('--bs-success');
...
if (typeof module !== 'undefined') {
    module.exports = IpixChartsWidget36;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixChartsWidget36.init();
});