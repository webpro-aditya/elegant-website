...
// Class definition
var IpixChartsWidget8 = function() {
    var chart1 = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function(chart, toggle, selector, data, initByDefault) {
        ...
        var options = {
            ...
            colors: [
                IpixUtil.getCssVariableValue('--bs-primary'),
                IpixUtil.getCssVariableValue('--bs-success'),
                IpixUtil.getCssVariableValue('--bs-warning'),
                IpixUtil.getCssVariableValue('--bs-danger'),
                IpixUtil.getCssVariableValue('--bs-info'),
                '#43CED7'
            ],
            fill: {
                opacity: 1,
    ...
    return {
        init: function() {
            ...
            var handlerId = IpixThemeMode.on("kt.thememode.change", function() {
                if (chart1.rendered) {
                    chart1.self.destroy();
                }
...
if (typeof module !== 'undefined') {
    module.exports = IpixChartsWidget8;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixChartsWidget8.init();
});