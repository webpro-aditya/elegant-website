...
// Class definition
var IpixChartsWidget1 = function() {
    var chart = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function() {
        ...
        var negativeColor = element.hasAttribute('data-kt-negative-color') ? element.getAttribute('data-kt-negative-color') : IpixUtil.getCssVariableValue('--bs-success');
        ...
        var baseColor = IpixUtil.getCssVariableValue('--bs-primary');
...
if (typeof module !== 'undefined') {
    module.exports = IpixChartsWidget1;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixChartsWidget1.init();
});