...
var IpixCardsWidget4 = function() {
    ...
    var initChart = function() {
        ...
        drawCircle(IpixUtil.getCssVariableValue('--bs-danger'), options.lineWidth, 100 / 150);
        drawCircle(IpixUtil.getCssVariableValue('--bs-primary'), options.lineWidth, 100 / 250);
    }
...
if (typeof module !== 'undefined') {
    module.exports = IpixCardsWidget4;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixCardsWidget4.init();
});