...
// Class definition
var IpixCardsWidget10 = function() {
    // Private methods
    var initChart = function() {
        ...
        drawCircle(IpixUtil.getCssVariableValue('--bs-primary'), options.lineWidth, 100 / 150);
        drawCircle(IpixUtil.getCssVariableValue('--bs-success'), options.lineWidth, 100 / 250);
    }
...
if (typeof module !== 'undefined') {
    module.exports = IpixCardsWidget10;
}

// On document ready
IpixUtil.onDOMContentLoaded(function() {
    IpixCardsWidget10.init();
});