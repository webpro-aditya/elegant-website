...
(function(factory) {
    ...
    DataTable.ext.renderer.pageButton.bootstrap = function(settings, host, idx, buttons, page, pages) {
        ...
        if (typeof IpixDatatable !== 'undefined' && IpixDatatable.invokePageInput) {
            // $(host).prepend('<input type="number" min="1" pattern="[1-9][0-9]*" data-kt-table-filter="page" value="' + currentPage + '" class="form-control w-100px float-start" placeholder="Page" />');
